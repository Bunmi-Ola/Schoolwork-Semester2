      ...
      public void executeChoices(int choice) {
        ...
        if (choice == 1) {
            ...
            menuOption4();
              ...
              SaveAll("C:\\Users\\Favour\\Desktop\\233EmployeeTestData.txt");
        }
       ...
       public void menuOption4() {
        ...
        public void menuOption6() {
                ...
                Date newHireDate = new Date(hiremonth, hireday, hireyear);
                 ...
                 employees[i].setMiddlelnit(newMiddlelnit);
                 employees[i].setMonthlySalary(newMonthlySalary);
                 employees[i].setBirthdate(newbirthDate);
                 employees[i].setHireDate(newHireDate);
                employees[i] = new Employee(newfirstname, newlasttname, newMiddlelnit, 
                        newbirthDate, newempNumber, newMonthlySalary, newHireDate);
                
                Employee[] tempPeople = new Employee[employees.length+1];
                System.arraycopy(employees, 0, tempPeople, 0, tempPeople.length);
