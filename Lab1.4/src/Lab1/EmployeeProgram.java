       ...
       public void menuOption4() {
        ...
        public void menuOption5() {
             Employee[] newEmployee = new Employee[1];
                ...
                Date newHireDate = new Date(hiremonth, hireday, hireyear);
                
                newEmployee[0] = new Employee(newfirstname, newlasttname, newMiddlelnit, 
                newbirthDate, newempNumber, newMonthlySalary, newHireDate);
                
                Employee[] tempPeople = new Employee[employees.length+1];
                System.arraycopy(employees, 0, tempPeople, 0, employees.length);
                System.arraycopy(newEmployee, 0, tempPeople, employees.length, newEmployee.length); 
                employees = tempPeople;
                SaveAll("X:\\Sem 2\\233EmployeeTestData.txt");
